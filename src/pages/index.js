...
function App() {
  ...
  return (
    <div id="App">
      ...
      <section>
        <h3>Sobre mim</h3>
        <p>Olá! Meu nome é <strong>Guilherme Balog Gardino</strong> e sou um desenvolvedor de software em São Paulo, Brasil.</p>
      ...
      <section>
        ...
        {formations.map((formation, i) => <FormationCard formation={formation} key={i} />)}
        {/* </div> */}
      </section>

      <section>
        <h3>Projetos web</h3>
        <p>Esses projetos são páginas estáticas, usando APIs de terceiros, alguns frameworks e um pouco de JavaScript puro também</p>
      ...
      <section>
        <h3>Projetos Node</h3>
        <p>Estes projetos são um pouco mais complexos, usando Node.js, React e mais. Alguns deles não estão no ar, mas o código está disponível de forma <i>open source</i>.</p>
        {/* <p>
